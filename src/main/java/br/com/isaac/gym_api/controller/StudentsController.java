...
public class StudentsController {
    ...
    @PostMapping
    public ResponseEntity<Map<String, String>> create(@Valid @RequestBody CreateStudentRequestDTO newStudent) {
    ...
    public ResponseEntity<List<PhysicalAssessmentResponseDTO>> findAllPhysicalAssessment(@PathVariable UUID id) {
